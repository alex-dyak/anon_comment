...
/**
 * @file
 * Contains \Drupal\anon_comment\Form\AnonConfirmDeleteMultiple.
 */
 ...
 */
class AnonConfirmDeleteMultiple extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'anon_comment_multiple_delete_confirm';
  }
  ...
  public function getCancelUrl() {
    return new Url('anon_comment.admin');
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if (!$comment_counter) {
      ...
      $form_state->setRedirect('anon_comment.admin');
    }
